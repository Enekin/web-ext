...
var _copyDir = __webpack_require__(65);
...
var _prettyjson = __webpack_require__(66);

var _prettyjson2 = _interopRequireDefault(_prettyjson);

var _tempDir = __webpack_require__(67);
...
var webExt = exports.webExt = process.env.TEST_WEB_EXT_BIN ? _path2.default.resolve(process.env.TEST_WEB_EXT_BIN) : _path2.default.join(projectDir, 'bin', 'web-ext');
...
function withTempAddonDir(_ref, makePromise) {
  ...
  return withTempDir(function (tmpDir) {
    ...
    return copyDirAsPromised(addonPath, tempAddonDir).then(function () {
      ...
      return makePromise(tempAddonDir, tmpDir.path()).then(function () {
...
(0, _mocha.describe)('web-ext', function () {
  (0, _mocha.it)('should accept: --help', function () {
    return (0, _common.withTempDir)(function (tmpDir) {
      var argv = ['--help'];
      var cmd = (0, _common.execWebExt)(argv, { cwd: tmpDir.path() });
